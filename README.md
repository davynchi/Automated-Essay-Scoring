...
- [ ] Еще один рефакторинг -- пересмотр своего кода
- [ ] Добавить аннотации типов
- [ ] Добавить возможность контроля выбранных частей кода (без файнтюна или
      только инференс) через Fire.
- [ ] Выделить расчет лучших весов в отдельный код и дать возможность запускать
